...
# Fill email input
acbrowser fill @e10 "user@example.com"

# Fill password
acbrowser fill @e11 "password123"
...
acbrowser snapshot -i          # Get refs first
acbrowser click @e1            # Use ref

# WRONG
acbrowser open https://example.com
acbrowser click @e1            # Ref doesn't exist yet!
```
...
acbrowser snapshot -i          # Get new refs
...
```bash
acbrowser click @e1            # Opens dropdown
acbrowser snapshot -i          # See dropdown items
acbrowser click @e7            # Select item
```
