...
# Network
agent-browser network requests                 # Inspect tracked requests (method, URL, status, request body, response body, response headers)
agent-browser network requests --filter api    # Filter requests by URL pattern
