      ...
      {envStatus && !envStatus.sandbox.hasSnapshot && (
        <Alert>
          ...
          <AlertDescription className="text-[11px]">
            Without a sandbox snapshot, the VM installs acbrowser +
      ...
      <header className="border-b border-border shrink-0">
        <div className="px-4 md:px-6 h-12 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <a
              href="https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fvercel-labs%2Facbrowser%2Ftree%2Fmain%2Fexamples%2Fenvironments&project-name=acbrowser-environments&repository-name=acbrowser-environments"
              target="_blank"
